...
sonuc = parseFloat("10.6"); //parseInt() metodundan farklı olarak geriye ondalıklı kısmıda döndürür.
...
sonuc = Math.floor(Math.random() * 100) + 50; //random() metodu 0 ile 1 arasında rastgele bir sayı üretir.
